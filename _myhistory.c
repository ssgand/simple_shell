...
/**
 * _myhistory - function to display the history list, one command by line,
...
/**
 * print_alias - function to print string alias
 * @node: the alias node
 *
 * Return: Always 0 on success, 1 on error
 */
...
/**
 * _myalias - functionn to mimic the builtin alias
